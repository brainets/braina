  ...
  1. First, use the frites_sim_ar tool to generate a simulated dataset with an autoregressive model (use ar_type='hga', n_epochs=50, n_times=300) and save it to sim_ar_data.nc.
